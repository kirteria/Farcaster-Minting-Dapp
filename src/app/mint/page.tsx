...
<div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100 flex flex-col items-center pt-10 px-4">  <div className="fixed top-6 right-4 flex gap-3 z-50">    
    {xUrl && (    
  ...
  </div>      <div className="w-full max-w-md mx-auto mb-4 mt-16">    
    <NFTImageSlider className="w-full aspect-square" />    
  </div>      <div className="w-full max-w-md mx-auto mb-3">    
...
{formatEth(Number(mintPrice) * quantity)} ETH
  ...
  <div className="flex items-center justify-center gap-3 mb-4">    
    ...
    </Button>    <div className="w-16 h-10 bg-white bg-opacity-60 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg">    
